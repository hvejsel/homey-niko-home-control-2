...
class NikoAccessControlDriver extends NikoDriver {
  async onPairListDevices(): Promise<DevicePairingData[]> {
    return super.getDevicesByAction(NIKO_ACTIONS[NikoDeviceKey.ACCESS_CONTROL]);
  }
}

module.exports = NikoAccessControlDriver;
